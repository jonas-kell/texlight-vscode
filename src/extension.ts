...
export async function activate(context: ExtensionContext) {
    const traceOutputChannel = window.createOutputChannel("Texlight Language Server trace");
    const command = process.env.SERVER_PATH || "texlight-language-server";
    ...
    client = new LanguageClient("texlight-language-server", "Texlight language server", serverOptions, clientOptions);
